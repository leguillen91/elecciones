    ...
    <div class="container">
        ...
        <nav class="text-center mb-4">
            <ul class="nav justify-content-center">
                <li class="nav-item"><a class="nav-link" href="#proceso-electoral">Proceso Electoral</a></li>
                <li class="nav-item"><a class="nav-link" href="#candidatos">Candidatos</a></li>
                <li class="nav-item"><a class="nav-link" href="#votacion">Votación</a></li>
        ...
        <main>
            ...
            <section id="votacion" class="mb-4">
                <h2>Votación</h2>
                <p>La votación es un derecho y un deber cívico. En esta sección, podrás participar en una votación simulada para entender mejor cómo se lleva a cabo el proceso. Aprenderás a marcar la boleta correctamente y a depositarla en la urna.</p>
                <button type="button" class="btn btn-success">Comenzar</button>
            </section>
